...
import { ShoppingBag, Calendar, TrendingUp, PieChart } from 'lucide-react';
import OrderStatusGraph from '@/components/business/orders/OrderStatusGraph';
...
const ClientHistoryCard: React.FC = () => {
  ...
  const getOrderStatusBadge = (status: Order['status']) => {
    ...
    return (
      <Badge className={`${variants[statusKey] || variants.pending} font-medium text-xs`}>
        {labels[statusKey] || labels.pending}
      </Badge>
    );
  };
