...
import { 
  Check, X, Calendar, User, Mail, DollarSign,
  MapPin, FileText,
} from 'lucide-react';
import { useOrders } from '@/features/orders/hooks';
import RejectOrderModal from '@/components/common/RejectOrderModal';
import {ApprovalStatusType, isPendingStatus} from '@/constants/approvalStatus';
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <DialogFooter className="flex justify-between sm:justify-between">
          {isPendingStatus(selectedOrder.status as ApprovalStatusType) && (
